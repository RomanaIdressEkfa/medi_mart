                                    ...
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active"><a href="#"><img src="{{asset('ui/frontend')}}/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                                                    <li><a href="#"><img src="{{asset('ui/frontend')}}/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                                                </ul>
                                            </div>
                                        </li>
                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    ...
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="{{asset('ui/frontend')}}/images/product/large-size/2.jpg" data-gall="myGallery">
                                            <img src="{{asset('ui/frontend')}}/images/product/large-size/2.jpg" alt="product image">
                                        </a>
                                    </div>
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="{{asset('ui/frontend')}}/images/product/large-size/3.jpg" data-gall="myGallery">
                                            <img src="{{asset('ui/frontend')}}/images/product/large-size/3.jpg" alt="product image">
                                        </a>
                                    </div>
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="{{asset('ui/frontend')}}/images/product/large-size/4.jpg" data-gall="myGallery">
                                            <img src="{{asset('ui/frontend')}}/images/product/large-size/4.jpg" alt="product image">
                                        </a>
                                    </div>
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="{{asset('ui/frontend')}}/images/product/large-size/5.jpg" data-gall="myGallery">
                                            <img src="{{asset('ui/frontend')}}/images/product/large-size/5.jpg" alt="product image">
                                        </a>
                                    </div>
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="{{asset('ui/frontend')}}/images/product/large-size/6.jpg" data-gall="myGallery">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="product-details" class="tab-pane" role="tabpanel">
                            <div class="product-details-manufacturer">
                                <a href="#">
                                    <img src="{{asset('ui/frontend')}}/images/product-details/1.jpg" alt="Product Manufacturer Image">
                                </a>
                                                    ...
                                                    <div class="modal-inner-area row">
                                                        <div class="col-lg-6">
                                                           <div class="li-review-product">
                                                               <img src="{{asset('ui/frontend')}}/images/product/large-size/3.jpg" alt="Li's Product">
